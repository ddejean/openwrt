...
{
	rtl8224_sds_write_field(phydev, RTL8224_SDS_NWAY_PAGE,
				RTL8224_SDS_NWAY_OPCODE_REG,
				RTL8224_SDS_NWAY_OPCODE_HIGH_BIT,
				RTL8224_SDS_NWAY_OPCODE_LOW_BIT, op_code);
}

static void rtl8224_sds_set_am_period(struct phy_device *phydev, u32 period)
{
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_PERIOD_REG,
				RTL8224_SDS_AM_PERIOD_HIGH_BIT,
				RTL8224_SDS_AM_PERIOD_LOW_BIT, period);
}

static void rtl8224_sds_set_all_am(struct phy_device *phydev, u32 value)
{
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG0_REG,
				RTL8224_SDS_AM0_M0_HIGH_BIT,
				RTL8224_SDS_AM0_M0_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG0_REG,
				RTL8224_SDS_AM0_M1_HIGH_BIT,
				RTL8224_SDS_AM0_M1_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG1_REG,
				RTL8224_SDS_AM0_M2_HIGH_BIT,
				RTL8224_SDS_AM0_M2_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG1_REG,
				RTL8224_SDS_AM1_M0_HIGH_BIT,
				RTL8224_SDS_AM1_M0_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG2_REG,
				RTL8224_SDS_AM1_M1_HIGH_BIT,
				RTL8224_SDS_AM1_M1_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG2_REG,
				RTL8224_SDS_AM1_M2_HIGH_BIT,
				RTL8224_SDS_AM1_M2_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG3_REG,
				RTL8224_SDS_AM2_M0_HIGH_BIT,
				RTL8224_SDS_AM2_M0_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG3_REG,
				RTL8224_SDS_AM2_M1_HIGH_BIT,
				RTL8224_SDS_AM2_M1_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG4_REG,
				RTL8224_SDS_AM2_M2_HIGH_BIT,
				RTL8224_SDS_AM2_M2_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG4_REG,
				RTL8224_SDS_AM3_M0_HIGH_BIT,
				RTL8224_SDS_AM3_M0_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG5_REG,
				RTL8224_SDS_AM3_M1_HIGH_BIT,
				RTL8224_SDS_AM3_M1_LOW_BIT, value);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_AM_CFG5_REG,
				RTL8224_SDS_AM3_M2_HIGH_BIT,
				RTL8224_SDS_AM3_M2_LOW_BIT, value);
}

static void rtl8224_sds_set_extra(struct phy_device *phydev)
{
	rtl8224_sds_write_field(phydev, RTL8224_SDS_AM_PAGE,
				RTL8224_SDS_TGR_PRO_0_REG17,
				RTL8224_SDS_USXG_V2P1P2_RXOFF_BIT,
				RTL8224_SDS_USXG_V2P1P2_RXOFF_BIT, 0x1);
	rtl8224_sds_write_field(phydev, RTL8224_SDS_NWAY_PAGE,
				RTL8224_SDS_TGR_PRO_1_REG19,
				RTL8224_SDS_USXG_RXDV_OFF_BIT,
				RTL8224_SDS_USXG_RXDV_OFF_BIT, 0x1);
}
